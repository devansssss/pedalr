...
export default function App() {
  ...
  return (
    <>
      ...
      {/* ── FOOTER ── */}
      <footer style={{
        borderTop:`1px solid ${T.border}`, padding:'32px clamp(20px, 5vw, 60px)',
        display:'flex', alignItems:'center', justifyContent:'space-between', flexWrap:'wrap', gap:16,
      }}>
        <div style={{ display:'flex', alignItems:'center', gap:10 }}>
          <LogoMark size={20} />
          <span style={{ fontFamily:'Barlow Condensed', fontWeight:700, fontSize:17, letterSpacing:'0.06em', color: T.white }}>
            PEDAL<span style={{ color: T.accent }}>R</span>
          </span>
        </div>
        ...
        <div style={{ display: 'flex', gap: 24, alignItems: 'center' }}>
          ...
          <div style={{ fontSize:13, color: T.muted, fontWeight:300 }}>
            © 2026 Pedalr.
          </div>
        </div>
      </footer>
